...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] shrink-0 scale-[0.45] sm:scale-[0.6] md:scale-[0.85] transform flex-col items-center justify-start py-10 md:py-40 lg:py-60 [perspective:800px]"
    >
      <motion.h2
        style={{
